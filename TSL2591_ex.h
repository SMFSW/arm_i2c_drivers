...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ TSL2591_SF_Force_IT(TSL2591_t * const pCpnt) {
...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ TSL2591_SF_Clear_IT(TSL2591_t * const pCpnt) {
...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ TSL2591_SF_Clear_IT_PERS(TSL2591_t * const pCpnt) {
...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ TSL2591_SF_Clear_PERS(TSL2591_t * const pCpnt) {
...
/*!\brief Interrupt GPIO pin init for TSL2591
** \weak TSL2591 Interrupt GPIO pin init may be user implemented if needed
** \param[in] pCpnt - Pointer to TSL2591 component
