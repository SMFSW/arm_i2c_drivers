...
GPMS_proc GPMS = { { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0.0f, '\0' }, { 0, 0.0f, '\0' }, 0, 0.0f, 0.0f, 0.0f, { 'A' } };
...
** \return Nothing
**/
static void GPMS_Fill_coords(GPMS_coord * coord, uint8_t * raw)
{
...
** \return Nothing
**/
static void GPMS_Fill_sp_hd(float * out, uint8_t * raw)
{
