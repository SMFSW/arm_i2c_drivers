...
**/
uint16_t NONNULL__ ADS1115_Get_conv_us(ADS1115_t * pCpnt);

/*!\brief Get conversion time for ADS1115 component (ms)
** \param[in] pCpnt - Pointer to ADS1115 component
** \return Conversion time in ms
**/
uint16_t NONNULL__ ADS1115_Get_conv_ms(ADS1115_t * pCpnt);
...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ ADS1115_Set_LowThreshold(ADS1115_t * pCpnt, const int16_t thrh) {
...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ ADS1115_Set_HighThreshold(ADS1115_t * pCpnt, const int16_t thrh) {
...
**/
__INLINE int16_t NONNULL_INLINE__ ADS1115_Get_LowThreshold(ADS1115_t * pCpnt) {
...
**/
__INLINE int16_t NONNULL_INLINE__ ADS1115_Get_HighThreshold(ADS1115_t * pCpnt) {
...
**/
__INLINE int16_t NONNULL_INLINE__ ADS1115_Get_raw_value(ADS1115_t * pCpnt, const uint8_t chan) {
