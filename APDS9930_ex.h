...
**/
/****************************************************************/
#ifndef __APDS9930_EX_H__
	#define __APDS9930_EX_H__
...
**/
typedef enum PACK__ APDS9930_light {
	APDS9930__LIGHT_FULL = 0,	//!< Full light spectrum (channel 0)
	APDS9930__LIGHT_IR,			//!< Infra Red light (channel 1)
	APDS9930__LIGHT_VISIBLE		//!< Visible light (channel 0 - channel 1)
} APDS9930_light;
...
typedef union uAPDS9930_REG_MAP {
	...
	struct {
		...
		uint8_t					:8;
		uint8_t					:8;
		uAPDS9930_REG__POFFSET	POFFSET;	//!< Proximity offset register
	} Reg;
} uAPDS9930_REG_MAP;
