...
** \param[in,out] pCpnt - Pointer to PCA9952 component
** \param[in] MODE1 - MODE1 register value
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_Set_MODE1(PCA9952_t * const pCpnt, const uPCA9952_REG__MODE1 MODE1) {
...
** \return FctERR - error code
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_Set_MODE2(PCA9952_t * const pCpnt, uPCA9952_REG__MODE2 MODE2) {
	MODE2.Byte = (MODE2.Byte | 0x05U) & ~0x82U;	// Setting reserved bits to appropriate values
	return PCA9952_Write(pCpnt->cfg.slave_inst, &MODE2.Byte, PCA9952__MODE2, sizeof(MODE2)); }


/*!\brief Set auto increment option for PCA9952 registers
** \param[in,out] pCpnt - Pointer to PCA9952 component
...
/*!\brief Set latch type for PCA9952 peripheral
** \param[in,out] pCpnt - Pointer to PCA9952 component
...
/*!\brief Set PCA9952 peripheral LED mode
** \param[in,out] pCpnt - Pointer to PCA9952 component
** \param[in] chan - PCA9952 channel
...
/*!\brief Set PCA9952 peripheral multiple LEDs mode
** \param[in,out] pCpnt - Pointer to PCA9952 component
** \param[in] chans - PCA9952 channels mask (masked channels will be affected to new mode, other ones remaining unchanged)
** \param[in] mode - channel mode (on/off/dimming/blinking)
** \return FctERR - error code
**/
...
/*!\brief Set PCA9952 output gain control value
** \param[in,out] pCpnt - Pointer to PCA9952 component
** \param[in] chan - PCA9952 channel
...
/*!\brief Set PCA9952 peripheral delay between channels
** \param[in,out] pCpnt - Pointer to PCA9952 component
...
/*!\brief Read PWM duty cycle array of values of a PCA9952
...
** \return FctERR - ErrorCode
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_ReadVals_Array(PCA9952_t * const pCpnt, uint8_t pDuty[], const PCA9xxx_chan start, const PCA9xxx_chan end) {
	return PCA9952_ReadVals(pCpnt, pDuty, false, start, end); }
...
** \return FctERR - ErrorCode
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_ReadVals_IndexedArray(PCA9952_t * const pCpnt, uint8_t pDuty[], const PCA9xxx_chan start, const PCA9xxx_chan end) {
	return PCA9952_ReadVals(pCpnt, pDuty, true, start, end); }


/*!\brief Read all PWM duty cycle array of values of a PCA9952 (for the 24 channels)
** \param[in] pCpnt - Pointer to PCA9952 component
** \param[in,out] pDuty - Pointer to duty cycle values (24 bytes)
** \return FctERR - ErrorCode
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_ReadVals_All(PCA9952_t * const pCpnt, uint8_t pDuty[24]) {
	return PCA9952_ReadVals(pCpnt, pDuty, false, PCA9xxx__PWM1, PCA9xxx__PWM16); }


/*!\brief Read PWM duty cycle value of a PCA9952 channel
** \param[in] pCpnt - Pointer to PCA9952 component
...
/*!\brief Send PWM duty cycle array of values to apply on a PCA9952
** \param[in] pCpnt - Pointer to PCA9952 component
...
** \return FctERR - ErrorCode
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_PutVals_Array(PCA9952_t * const pCpnt, const uint8_t pDuty[], const PCA9xxx_chan start, const PCA9xxx_chan end) {
	return PCA9952_PutVals(pCpnt, pDuty, false, start, end); }
...
** \return FctERR - ErrorCode
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_PutVals_IndexedArray(PCA9952_t * const pCpnt, const uint8_t pDuty[], const PCA9xxx_chan start, const PCA9xxx_chan end) {
	return PCA9952_PutVals(pCpnt, pDuty, true, start, end); }


/*!\brief Send all PWM duty cycle array of values to apply on a PCA9952 (for the 24 channels)
** \param[in] pCpnt - Pointer to PCA9952 component
** \param[in] pDuty - Pointer to duty cycle values (24 bytes)
** \return FctERR - ErrorCode
**/
__INLINE FctERR NONNULL_INLINE__ PCA9952_PutVals_All(PCA9952_t * const pCpnt, const uint8_t pDuty[24]) {
	return PCA9952_PutVals(pCpnt, pDuty, false, PCA9xxx__PWM1, PCA9xxx__PWM16); }


/*!\brief Send PWM duty cycle value to apply on a PCA9952 channel
** \param[in] pCpnt - Pointer to PCA9952 component
** \param[in] chan - channel number
...
/*!\brief Send PWM Full ON value to apply on a PCA9952 channel
** \param[in] pCpnt - Pointer to PCA9952 component
** \param[in] chan - channel number
** \return FctERR - ErrorCode
**/
...
/*!\brief Send PWM Full OFF value to apply on a PCA9952 channel
** \param[in] pCpnt - Pointer to PCA9952 component
** \param[in] chan - channel number
** \return FctERR - ErrorCode
**/
...
/*!\brief Read register from PCA9952
** \param[in] pCpnt - Pointer to PCA9952 component
...
/*!\brief Reset GPIO pin init for PCA9952
** \weak PCA9952 Reset GPIO pin init may be user implemented if needed
** \param[in] pCpnt - Pointer to PCA9952 component
...
** \weak PCA9952 Output Enable GPIO pin init may be user implemented if needed
