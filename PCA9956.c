...
I2C_slave_t PCA9956_hal[I2C_PCA9956_NB];
...
FctERR NONNULL__ PCA9956_Init(const uint8_t idx, const I2C_HandleTypeDef * hi2c, const uint16_t devAddress)
{
	...
	I2C_PERIPHERAL_SET_DEFAULTS(PCA9956, idx, devAddress);
...
#warning "You have to define I2C_PCA9956 for component to be enabled!"
#endif
#endif
/****************************************************************/
