...
#define DRV2605L_BASE_ADDR		0x5AU		//!< DRV2605L Base address
#endif
...
typedef enum PACK__ {
	...
	DRV__EFF_SHARP_CLK_100 = 4U,						//!< Sharp Click - 100%
	DRV__EFF_SHARP_CLK_60 = 5U,							//!< Sharp Click - 60%
	DRV__EFF_SHARP_CLK_30 = 6U,							//!< Sharp Click - 30%
	DRV__EFF_SOFT_BUMP_100 = 7U,						//!< Soft Bump - 100%
	DRV__EFF_SOFT_BUMP_60 = 8U,							//!< Soft Bump - 60%
	DRV__EFF_SOFT_BUMP_30 = 9U,							//!< Soft Bump - 30%
	DRV__EFF_DBL_CLK_100 = 10U,							//!< Double Click - 100%
	DRV__EFF_DBL_CLK_60 = 11U,							//!< Double Click - 60%
	DRV__EFF_DBL_CLK_30 = 12U,							//!< Triple Click - 100%
	DRV__EFF_SOFT_FUZZ_60 = 13U,						//!< Soft Fuzz - 60%
	DRV__EFF_STRONG_BUZZ_100 = 14U,						//!< Strong Buzz - 100%
	DRV__EFF_ALERT_750MS = 15U,							//!< 750ms Alert 100%
	DRV__EFF_ALERT_1000MS = 16U,						//!< 1000ms Alert 100%
	DRV__EFF_STRONG_CLK_1 = 17U,						//!< Strong Click 1 - 100%
	DRV__EFF_STRONG_CLK_2 = 18U,						//!< Strong Click 2 - 80%
	DRV__EFF_STRONG_CLK_3 = 19U,						//!< Strong Click 3 - 60%
	DRV__EFF_STRONG_CLK_4 = 20U,						//!< Strong Click 4 - 30%
	DRV__EFF_MEDIUM_CLK_1 = 21U,						//!< Medium Click 1 - 100%
	DRV__EFF_MEDIUM_CLK_2 = 22U,						//!< Medium Click 2 - 80%
	DRV__EFF_MEDIUM_CLK_3 = 23U,						//!< Medium Click 3 - 60%
	DRV__EFF_SHARP_TICK_1 = 24U,						//!< Sharp Tick 1 - 100%
	DRV__EFF_SHARP_TICK_2 = 25U,						//!< Sharp Tick 2 - 80%
	DRV__EFF_SHARP_TICK_3 = 26U,						//!< Sharp Tick 3 - 60%
	DRV__EFF_SHORT_DBL_CLK_STRONG_1 = 27U,				//!< Short Double Click Strong 1 - 100%
	DRV__EFF_SHORT_DBL_CLK_STRONG_2 = 28U,				//!< Short Double Click Strong 2 - 80%
	DRV__EFF_SHORT_DBL_CLK_STRONG_3 = 29U,				//!< Short Double Click Strong 3 - 60%
	DRV__EFF_SHORT_DBL_CLK_STRONG_4 = 30U,				//!< Short Double Click Strong 4 - 30%
	DRV__EFF_SHORT_DBL_CLK_MEDIUM_1 = 31U,				//!< Short Double Click Medium 1 - 100%
	DRV__EFF_SHORT_DBL_CLK_MEDIUM_2 = 32U,				//!< Short Double Click Medium 2 - 80%
	DRV__EFF_SHORT_DBL_CLK_MEDIUM_3 = 33U,				//!< Short Double Click Medium 3 - 60%
	DRV__EFF_SHORT_DBL_SHARP_TICK_1 = 34U,				//!< Short Double Sharp Tick 1 - 100%
	DRV__EFF_SHORT_DBL_SHARP_TICK_2 = 35U,				//!< Short Double Sharp Tick 2 - 80%
	DRV__EFF_SHORT_DBL_SHARP_TICK_3 = 36U,				//!< Short Double Sharp Tick 3 - 60%
	DRV__EFF_LONG_DBL_CLK_STRONG_1 = 37U,				//!< Long Double Sharp Click Strong 1 - 100%
	DRV__EFF_LONG_DBL_CLK_STRONG_2 = 38U,				//!< Long Double Sharp Click Strong 2 - 80%
	DRV__EFF_LONG_DBL_CLK_STRONG_3 = 39U,				//!< Long Double Sharp Click Strong 3 - 60%
	DRV__EFF_LONG_DBL_CLK_STRONG_4 = 40U,				//!< Long Double Sharp Click Strong 4 - 30%
	DRV__EFF_LONG_DBL_CLK_MEDIUM_1 = 41U,				//!< Long Double Sharp Click Medium 1 - 100%
	DRV__EFF_LONG_DBL_CLK_MEDIUM_2 = 42U,				//!< Long Double Sharp Click Medium 2 - 80%
	DRV__EFF_LONG_DBL_CLK_MEDIUM_3 = 43U,				//!< Long Double Sharp Click Medium 3 - 60%
	DRV__EFF_LONG_DBL_SHARP_TICK_1 = 44U,				//!< Long Double Sharp Tick 1 - 100%
	DRV__EFF_LONG_DBL_SHARP_TICK_2 = 45U,				//!< Long Double Sharp Tick 2 - 80%
	DRV__EFF_LONG_DBL_SHARP_TICK_3 = 46U,				//!< Long Double Sharp Tick 3 - 60%
	DRV__EFF_BUZZ_1 = 47U,								//!< Buzz 1 - 100%
	DRV__EFF_BUZZ_2 = 48U,								//!< Buzz 2 - 80%
	DRV__EFF_BUZZ_3 = 49U,								//!< Buzz 3 - 60%
	DRV__EFF_BUZZ_4 = 50U,								//!< Buzz 4 - 40%
	DRV__EFF_BUZZ_5 = 51U,								//!< Buzz 5 - 20%
	DRV__EFF_PULSING_STRONG_1 = 52U,					//!< Pulsing Strong 1 - 100%
	DRV__EFF_PULSING_STRONG_2 = 53U,					//!< Pulsing Strong 2 - 60%
	DRV__EFF_PULSING_MEDIUM_1 = 54U,					//!< Pulsing Medium 1 - 100%
	DRV__EFF_PULSING_MEDIUM_2 = 55U,					//!< Pulsing Medium 2 - 60%
	DRV__EFF_PULSING_SHARP_1 = 56U,						//!< Pulsing Sharp 1 - 100%
	DRV__EFF_PULSING_SHARP_2 = 57U,						//!< Pulsing Sharp 2 - 60%
	DRV__EFF_TRANS_CLK_1 = 58U,							//!< Transition Click 1 - 100%
	DRV__EFF_TRANS_CLK_2 = 59U,							//!< Transition Click 2 - 80%
	DRV__EFF_TRANS_CLK_3 = 60U,							//!< Transition Click 3 - 60%
	DRV__EFF_TRANS_CLK_4 = 61U,							//!< Transition Click 4 - 40%
	DRV__EFF_TRANS_CLK_5 = 62U,							//!< Transition Click 5 - 20%
	DRV__EFF_TRANS_CLK_6 = 63U,							//!< Transition Click 6 - 10%
	DRV__EFF_TRANS_HUM_1 = 64U,							//!< Transition Hum 1 - 100%
	DRV__EFF_TRANS_HUM_2 = 65U,							//!< Transition Hum 2 - 80%
	DRV__EFF_TRANS_HUM_3 = 66U,							//!< Transition Hum 3 - 60%
	DRV__EFF_TRANS_HUM_4 = 67U,							//!< Transition Hum 4 - 40%
	DRV__EFF_TRANS_HUM_5 = 68U,							//!< Transition Hum 5 - 20%
	DRV__EFF_TRANS_HUM_6 = 69U,							//!< Transition Hum 6 - 10%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SMOOTH_1 = 70U,		//!< Transition Ramp Down Long Smooth 1 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SMOOTH_2 = 71U,		//!< Transition Ramp Down Long Smooth 2 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SMOOTH_1 = 72U,		//!< Transition Ramp Down Medium Smooth 1 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SMOOTH_2 = 73U,		//!< Transition Ramp Down Medium Smooth 2 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SMOOTH_1 = 74U,		//!< Transition Ramp Down Short Smooth 1 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SMOOTH_2 = 75U,		//!< Transition Ramp Down Short Smooth 2 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SHARP_1 = 76U,			//!< Transition Ramp Down Long Sharp 1 - 100 t0 0%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SHARP_2 = 77U,			//!< Transition Ramp Down Long Sharp 2 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SHARP_1 = 78U,		//!< Transition Ramp Down Medium Sharp 1 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SHARP_2 = 79U,		//!< Transition Ramp Down Medium Sharp 2 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SHARP_1 = 80U,		//!< Transition Ramp Down Short Sharp 1 - 100 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SHARP_2 = 81U,		//!< Transition Ramp Down Short Sharp 2 - 100 to 0%
	DRV__EFF_TRANS_RAMP_UP_LONG_SMOOTH_1 = 82U,			//!< Transition Ramp Up Long Smooth 1 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_LONG_SMOOTH_2 = 83U,			//!< Transition Ramp Up Long Smooth 2 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SMOOTH_1 = 84U,		//!< Transition Ramp Up Medium Smooth 1 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SMOOTH_2 = 85U,		//!< Transition Ramp Up Medium Smooth 2 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SMOOTH_1 = 86U,		//!< Transition Ramp Up Short Smooth 1 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SMOOTH_2 = 87U,		//!< Transition Ramp Up Short Smooth 2 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_LONG_SHARP_1 = 88U,			//!< Transition Ramp Up Long Sharp 1 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_LONG_SHARP_2 = 89U,			//!< Transition Ramp Up Long Sharp 2 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SHARP_1 = 90U,		//!< Transition Ramp Up Medium Sharp 1 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SHARP_2 = 91U,		//!< Transition Ramp Up Medium Sharp 2 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SHARP_1 = 92U,			//!< Transition Ramp Up Short Sharp 1 - 0 to 100%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SHARP_2 = 93U,			//!< Transition Ramp Up Short Sharp 2 - 0 to 100%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SMOOTH_1_LOW = 94U,	//!< Transition Ramp Down Long Smooth 1 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SMOOTH_2_LOW = 95U,	//!< Transition Ramp Down Long Smooth 2 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SMOOTH_1_LOW = 96U,	//!< Transition Ramp Down Medium Smooth 1 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SMOOTH_2_LOW = 97U,	//!< Transition Ramp Down Medium Smooth 2 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SMOOTH_1_LOW = 98U,	//!< Transition Ramp Down Short Smooth 1 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SMOOTH_2_LOW = 99U,	//!< Transition Ramp Down Short Smooth 2 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SHARP_1_LOW = 100U,	//!< Transition Ramp Down Long Sharp 1 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_LONG_SHARP_2_LOW = 101U,	//!< Transition Ramp Down Long Sharp 2 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SHARP_1_LOW = 102U,	//!< Transition Ramp Down Medium Sharp 1 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_MEDIUM_SHARP_2_LOW = 103U,	//!< Transition Ramp Down Medium Sharp 2 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SHARP_1_LOW = 104U,	//!< Transition Ramp Down Short Sharp 1 - 50 to 0%
	DRV__EFF_TRANS_RAMP_DWN_SHORT_SHARP_2_LOW = 105U,	//!< Transition Ramp Down Short Sharp 2 - 50 to 0%
	DRV__EFF_TRANS_RAMP_UP_LONG_SMOOTH_1_LOW = 106U,	//!< Transition Ramp Up Long Smooth 1 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_LONG_SMOOTH_2_LOW = 107U,	//!< Transition Ramp Up Long Smooth 2 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SMOOTH_1_LOW = 108U,	//!< Transition Ramp Up Medium Smooth 1 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SMOOTH_2_LOW = 109U,	//!< Transition Ramp Up Medium Smooth 2 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SMOOTH_1_LOW = 110U,	//!< Transition Ramp Up Short Smooth 1 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SMOOTH_2_LOW = 111U,	//!< Transition Ramp Up Short Smooth 2 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_LONG_SHARP_1_LOW = 112U,		//!< Transition Ramp Up Long Sharp 1 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_LONG_SHARP_2_LOW = 113U,		//!< Transition Ramp Up Long Sharp 2 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SHARP_1_LOW = 114U,	//!< Transition Ramp Up Medium Sharp 1 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_MEDIUM_SHARP_2_LOW = 115U,	//!< Transition Ramp Up Medium Sharp 2 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SHARP_1_LOW = 116U,	//!< Transition Ramp Up Short Sharp 1 - 0 to 50%
	DRV__EFF_TRANS_RAMP_UP_SHORT_SHARP_2_LOW = 117U,	//!< Transition Ramp Up Short Sharp 2 - 0 to 50%
	DRV__EFF_LONG_BUZZ = 118U,							//!< Long buzz for programmatic stopping - 100%
	DRV__EFF_SMOOTH_HUM_1 = 119U,						//!< Smooth Hum 1 (No kick or brake pulse) - 50%
	DRV__EFF_SMOOTH_HUM_2 = 120U,						//!< Smooth Hum 2 (No kick or brake pulse) - 40%
	DRV__EFF_SMOOTH_HUM_3 = 121U,						//!< Smooth Hum 3 (No kick or brake pulse) - 30%
	DRV__EFF_SMOOTH_HUM_4 = 122U,						//!< Smooth Hum 4 (No kick or brake pulse) - 20%
	DRV__EFF_SMOOTH_HUM_5 = 123U						//!< Smooth Hum 5 (No kick or brake pulse) - 10%
} DRV2605L_eff;
